...
KNN duplicate vs unique - unique makes the dataset much smaller! More efficient for testing..
...
k <- 5
knn.type <- "Unique"     # KNN method: "Unique", "Duplicate"
...
vs <- "CloneBVsAll"
s <- c(12,13)           #c(8,7) or NULL
q <- NULL             #c(2,3) or NULL
pval <- 0.05
