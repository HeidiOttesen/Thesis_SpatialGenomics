...
files <- list.files("~/Thesis_SpatialGenomics/Vesalius1Dev/Vesalius/R",pattern = ".R")
files <- paste0("~/Thesis_SpatialGenomics/Vesalius1Dev/Vesalius/R/",files)
...
Remove everything and use buildvesaliusembeddings instead from the embeddings file! 
...
image.array <- image
#April14_imageArray <- image.array
...
What is the tile element in the image list representing? Is it the original count values? Do we still need them?
