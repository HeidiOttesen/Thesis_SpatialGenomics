...
logfc.min <- slice_min(padj, order_by=padj$logFC, prop=0.08)
logfc.max <- slice_max(padj, order_by=padj$logFC, prop=0.08)
...
bin.file <- read.table("~/Thesis_SpatialGenomics/SlideSeq/GroupSlideSeq/hg19_1Mb_bins.txt", header = T)
chr <- data_frame()
for(i in seq_along(logfc$genes)){
