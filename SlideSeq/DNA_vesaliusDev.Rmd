...
#alias <- "mouse_liver_met_1_dna_191114_05"
alias <- "mouse_liver_met_1_dna_191114_06"
...
out.pathDev <- "~/Thesis_SpatialGenomics/R_Output/VesaliusDev/mouse_liver_1/"
...
s <- c(8,7)
q <- c(2,3)
layer <- "FALSE"           # Set TRUE or FALSE whether you want to show the marker bin distribution per territory or per cell?
