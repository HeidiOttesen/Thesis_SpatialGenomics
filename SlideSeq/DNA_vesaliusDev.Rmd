...
s <- c(3)                   #eg c(8,7) or NULL c(8,9,4,6) c(10,11)
q <- c(2)           #eg c(7,5) or NULL
...
```{r}
How many bins do you have? - Grid.arrange
layer <- "FALSE"           
p <- list()
...
```{r}
genes <- genesBioMart(bin.chr, alias)
