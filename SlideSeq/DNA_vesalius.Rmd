...
Either by Seurats functions or using SCTransform
...
norm <- "SCTransform"
ctmp.sct <- SCTransform(ctmp, assay = "Spatial", verbose = FALSE)
```
...
dimred <- "PCA_3slices"
ctmp.pca <- rgbPCA(ctmp.sct, slices = 3 , conserveSparse = FALSE)
